...
# Options for theme
html_theme_options = {
    "github_url": "https://github.com/ameli/pyrand",
    "navbar_end": [
        "theme-switcher",
        "search-field.html",
    ...
    "icon_links": [
        {
            "name": "PyPI",
            "url": "https://pypi.org/project/pyrand/",
            "icon": "fab fa-python",
            "type": "fontawesome",
        },
        {
            "name": "Anaconda Cloud",
            "url": "https://anaconda.org/s-ameli/pyrand",
            "icon": "fa fa-circle-notch",
            "type": "fontawesome",
        },
        {
            "name": "Docker Hub",
            "url": "https://hub.docker.com/r/sameli/pyrand",
            "icon": "fab fa-docker",
            "type": "fontawesome",
        },
        {
            "name": "Lanuch Jupyter on Binder",
            "url": "https://mybinder.org/v2/gh/ameli/pyrand/HEAD?filepath=notebooks%2FInterpolateTraceOfInverse.ipynb",
    ...
    "logo": {
        "image_light": "images/icons/logo-pyrand-light.png",
        "image_dark": "images/icons/logo-pyrand-dark.png",
    },
}
...
# html_logo = '_static/images/icons/logo-pyrand-light.png'
