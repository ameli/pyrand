...
* Compile |project| with a specific CUDA version compatible with your existing CUDA installation. See :ref:`Compile pyrand from Source <compile-pyrand>`.
...
* To run the container and open *IPython* interpreter directly at startup:
  ...
  .. prompt:: bash
        ...
        docker run -it sameli/pyrand ipython
