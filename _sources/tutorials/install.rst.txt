...
Install |project| and its Python dependencies through `PyPI <https://pypi.org/project/pyrand>`_ by
...
Alternately, install |project| and its Python dependencies from `Anaconda Cloud <https://anaconda.org/s-ameli/pyrand>`_ by
...
4. Install ``pyrand`` package with any of the :ref:`above methods <install-wheels>`. For instance:
...
4. Install ``pyrand`` with any of the :ref:`above methods <install-wheels>`. For instance:
...
`OpenBLAS <https://www.openblas.net/>`_ is a library for efficient dense matrix operations. |project| does not require this library as it has its own library for dense matrices. However, if you compiled |project| to use OpenBLAS (see :ref:`Compile from Source <compile-pyrand>`), OpenBLAS library should be available at runtime.
...
.. attention::
    ...
    Do not load pyrand if your current working directory is the root directory of the source code of |project|, since python cannot load the installed package properly. Always change the current directory to somewhere else (for example, ``cd ..`` as shown in the above).
...
The package can be tested by running several `test scripts <https://github.com/ameli/pyrand/tree/main/tests>`_, which test all `sub-packages <https://github.com/ameli/pyrand/tree/main/pyrand>`_ and `examples <https://github.com/ameli/pyrand/tree/main/examples>`_.
...
.. attention::
    ...
    To properly run ``pytest``, rename ``/pyrand/pyrand`` directory as shown in the above code. This makes ``pytest`` to properly import |project| from the installed location, not from the source code directory.
...
.. |conda| image:: https://anaconda.org/s-ameli/pyrand/badges/installer/conda.svg
   :target: https://anaconda.org/s-ameli/pyrand
.. |platforms| image:: https://img.shields.io/conda/pn/s-ameli/pyrand?color=orange?label=platforms
   :target: https://anaconda.org/s-ameli/pyrand
.. |conda-version| image:: https://img.shields.io/conda/v/s-ameli/pyrand
   :target: https://anaconda.org/s-ameli/pyrand
.. |release| image:: https://img.shields.io/github/v/tag/ameli/pyrand
   :target: https://github.com/ameli/pyrand/releases/
.. |conda-platform| image:: https://anaconda.org/s-ameli/pyrand/badges/platforms.svg
   :target: https://anaconda.org/s-ameli/pyrand
.. |repo-size| image:: https://img.shields.io/github/repo-size/ameli/pyrand
