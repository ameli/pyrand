...
from pyrand.sample_matrices import correlation_matrix               # noqa: E402
from pyrand import InterpolateSchatten                              # noqa: E402
...
def _remove_saved_plot(filename):
    """
    When the option ``plot=True`` is used in :mod:`pyrand.correlation_matrix`, a
...
def _interpolate_trace_exp(p):
    ...
    print("")
    print("----------------------------------------")
    print("Method  Options         pyrand     Error")
    print("------  -------------   --------  ------")
...
def test_interpolate_trace():
    """
    Tests pyrand.InterpolateSchatten class.
    """
