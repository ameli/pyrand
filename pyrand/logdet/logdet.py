...
def logdet(
    ...
    A : numpy.ndarray, scipy.sparse, :class:`pyrand.Matrix`, or \
        ...
        :ref:`slq method <pyrand.logdet.slq>`. If ``method=cholesky``, the
    ...
    method : {'eigenvalue', 'cholesky', 'slq'}, default='cholesky'
        ...
        * :ref:`eigenvalue <pyrand.logdet.eigenvalue>`
        * :ref:`cholesky <pyrand.logdet.cholesky>`
        * :ref:`slq <pyrand.logdet.slq>`
    ...
    info : dict
        ...
        * ``matrix``:
            ...
            * ``num_inquiries``: `int`, The size of inquiries of each parameter
              ...
              `1`. For more details see :ref:`slq method <pyrand.logdet.slq>`.
    ...
    * :ref:`eigenvalue <pyrand.logdet.eigenvalue>`: uses spectral decomposition.
      Suitable for small matrices (:math:`n < 2^{12}`). The solution is exact.
    * :ref:`cholesky <pyrand.logdet.cholesky>`: uses Cholesky decomposition.
      Suitable for moderate-size matrices (:math:`n < 2^{15}`). Can only be
      applied to positive-definite matrices. The solution is exact.
    * :ref:`slq <pyrand.logdet.slq>`: uses stochastic Lanczos quadrature (SLQ),
    ...
    **Large matrix:**
    ...
    :func:`pyrand.sample_matrices.toeplitz_logdet` for details.

    .. code-block:: python

        >>> from pyrand.sample_matrices import toeplitz_logdet
    ...
    **Matrix operator:**
    ...
    :ref:`slq method <pyrand.logdet.slq>`.

    .. code-block:: python
        :emphasize-lines: 8

        >>> # Import matrix operator
        >>> from pyrand import toeplitz, logdet, Matrix
    ...
    **Affine matrix operator:**
    ...
    in :ref:`slq method <pyrand.logdet.slq>`.

    .. code-block:: python
        :emphasize-lines: 8

        >>> # Import affine matrix function
        >>> from pyrand import toeplitz, logdet, AffineMatrixFunction
