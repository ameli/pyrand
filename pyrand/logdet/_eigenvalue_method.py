...
def eigenvalue_method(
    ...
    **Dense matrix:**
    ...
    by :func:`pyrand.toeplitz` function:
    ...
    **Precomputed Eigenvalues:**
    ...
    Pre-computing eigenvalues can be useful if :func:`pyrand.logdet` function
    ...
    **Sparse matrix:**
    ...
    :func:`pyrand.sample_matrices.toeplitz_logdet` function.
