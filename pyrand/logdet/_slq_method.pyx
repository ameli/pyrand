...
def slq_method(
    ...
    **Symmetric Input Matrix:**
    ...
    The `slq` method requires the input matrix of :func:`pyrand.logdet` function
    to be symmetric when ``gram`` is `False`. For the first example, generate a
    symmetric sample matrix using :func:`pyrand.toeplitz` function as follows:
    ...
    **Gramian Matrix:**
    ...
    Passing ``gram=True`` to :func:`pyrand.logdet` function uses the Gramian
    ...
    **Verbose output:**
    ...
    .. literalinclude:: ../_static/data/pyrand.logdet.slq-verbose-1.txt
        :language: python
    ...
    **Affine matrix operator:**
    ...
    .. literalinclude:: ../_static/data/pyrand.logdet.slq-verbose-2.txt
        :language: python
