...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "language": "c++",
        "name": "pyrand.traceinv._hutchinson_method_utilities",
        "sources": [
            "./pyrand/traceinv/_hutchinson_method_utilities.pyx",
            "pyrand/functions/functions.cpp",
    ...
    "module_name": "pyrand.traceinv._hutchinson_method_utilities"
}
END: Cython Metadata */
...
#define __PYX_HAVE__pyrand__traceinv___hutchinson_method_utilities
#define __PYX_HAVE_API__pyrand__traceinv___hutchinson_method_utilities
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from 'pyrand.traceinv._hutchinson_method_utilities' */
#define __Pyx_MODULE_NAME "pyrand.traceinv._hutchinson_method_utilities"
extern int __pyx_module_is_main_pyrand__traceinv___hutchinson_method_utilities;
int __pyx_module_is_main_pyrand__traceinv___hutchinson_method_utilities = 0;

/* Implementation of 'pyrand.traceinv._hutchinson_method_utilities' */
...
static const char __pyx_k_pyrand_traceinv__hutchinson_meth[] = "pyrand/traceinv/_hutchinson_method_utilities.pyx";
...
static const char __pyx_k_pyrand_traceinv__hutchinson_meth_2[] = "pyrand.traceinv._hutchinson_method_utilities";
...
static PyObject *__pyx_kp_s_pyrand_traceinv__hutchinson_meth;
static PyObject *__pyx_n_s_pyrand_traceinv__hutchinson_meth_2;
...
/* "pyrand/traceinv/_hutchinson_method_utilities.pyx":22
 * # ===============
 * 
 * def check_arguments(             # <<<<<<<<<<<<<<
 *         A,
...
/* Python wrapper */
static PyObject *__pyx_pw_6pyrand_8traceinv_28_hutchinson_method_utilities_1check_arguments(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_6pyrand_8traceinv_28_hutchinson_method_utilities_check_arguments[] = "check_arguments(A, B, C, gram, exponent, assume_matrix, min_num_samples, max_num_samples, error_atol, error_rtol, confidence_level, outlier_significance_level, solver_tol, orthogonalize, num_threads, verbose, plot)\n\n    Checks the type and value of the parameters.\n    ";
static PyMethodDef __pyx_mdef_6pyrand_8traceinv_28_hutchinson_method_utilities_1check_arguments = {"check_arguments", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_6pyrand_8traceinv_28_hutchinson_method_utilities_1check_arguments, METH_VARARGS|METH_KEYWORDS, __pyx_doc_6pyrand_8traceinv_28_hutchinson_method_utilities_check_arguments};
static PyObject *__pyx_pw_6pyrand_8traceinv_28_hutchinson_method_utilities_1check_arguments(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("pyrand.traceinv._hutchinson_method_utilities.check_arguments", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_6pyrand_8traceinv_28_hutchinson_method_utilities_check_arguments(__pyx_self, __pyx_v_A, __pyx_v_B, __pyx_v_C, __pyx_v_gram, __pyx_v_exponent, __pyx_v_assume_matrix, __pyx_v_min_num_samples, __pyx_v_max_num_samples, __pyx_v_error_atol, __pyx_v_error_rtol, __pyx_v_confidence_level, __pyx_v_outlier_significance_level, __pyx_v_solver_tol, __pyx_v_orthogonalize, __pyx_v_num_threads, __pyx_v_verbose, __pyx_v_plot);
...
static PyObject *__pyx_pf_6pyrand_8traceinv_28_hutchinson_method_utilities_check_arguments(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_A, PyObject *__pyx_v_B, PyObject *__pyx_v_C, PyObject *__pyx_v_gram, PyObject *__pyx_v_exponent, PyObject *__pyx_v_assume_matrix, PyObject *__pyx_v_min_num_samples, PyObject *__pyx_v_max_num_samples, PyObject *__pyx_v_error_atol, PyObject *__pyx_v_error_rtol, PyObject *__pyx_v_confidence_level, PyObject *__pyx_v_outlier_significance_level, PyObject *__pyx_v_solver_tol, PyObject *__pyx_v_orthogonalize, PyObject *__pyx_v_num_threads, PyObject *__pyx_v_verbose, PyObject *__pyx_v_plot) {
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":45
 * 
 *     # Check A
 ...
 */
  ...
  if (unlikely(__pyx_t_1)) {
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":46
 *     # Check A
 *     if (not isinstance(A, numpy.ndarray)) and (not isspmatrix(A)):
 *         raise TypeError('Input matrix should be either a "numpy.ndarray" or ' +             # <<<<<<<<<<<<<<
 *                         'a "scipy.sparse" matrix.')
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":48
 *         raise TypeError('Input matrix should be either a "numpy.ndarray" or ' +
 *                         'a "scipy.sparse" matrix.')
 *     elif A.shape[0] != A.shape[1]:             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (unlikely(__pyx_t_1)) {
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":49
 *                         'a "scipy.sparse" matrix.')
 *     elif A.shape[0] != A.shape[1]:
 *         raise ValueError('Input matrix should be a square matrix.')             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":52
 * 
 *     # Check B
 *     if B is not None:             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_t_4) {
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":53
 *     # Check B
 *     if B is not None:
 *         if (isinstance(A, numpy.ndarray)) and \             # <<<<<<<<<<<<<<
 *                 (not isinstance(B, numpy.ndarray)):
 ...
 */
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":54
 *     if B is not None:
 *         if (isinstance(A, numpy.ndarray)) and \
 *                 (not isinstance(B, numpy.ndarray)):             # <<<<<<<<<<<<<<
 *             raise TypeError('When the input matrix "A" is of type ' +
 ...
 */
    ...
    if (unlikely(__pyx_t_4)) {
      ...
      /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":55
 *         if (isinstance(A, numpy.ndarray)) and \
 *                 (not isinstance(B, numpy.ndarray)):
 *             raise TypeError('When the input matrix "A" is of type ' +             # <<<<<<<<<<<<<<
 *                             '"numpy.ndarray", matrix "B" should also be of ' +
 ...
 */
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":58
 *                             '"numpy.ndarray", matrix "B" should also be of ' +
 *                             'the same type.')
 ...
 */
    ...
    if (unlikely(__pyx_t_4)) {
      ...
      /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":59
 *                             'the same type.')
 *         if isspmatrix(A) and not isspmatrix(B):
 *             raise TypeError('When the input matrix "A" is of type ' +             # <<<<<<<<<<<<<<
 *                             '"scipy.sparse", matrix "B" should also be of ' +
 ...
 */
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":62
 *                             '"scipy.sparse", matrix "B" should also be of ' +
 *                             'the same type.')
 ...
 */
    ...
    if (unlikely(__pyx_t_4)) {
      ...
      /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":63
 *                             'the same type.')
 *         elif A.shape != B.shape:
 *             raise ValueError('Matrix "B" should have the same size as ' +             # <<<<<<<<<<<<<<
 *                              'matrix "A".')
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":67
 * 
 *     # Check C
 *     if C is not None:             # <<<<<<<<<<<<<<
 *         if B is None:
 ...
 */
  ...
  if (__pyx_t_5) {
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":68
 *     # Check C
 *     if C is not None:
 *         if B is None:             # <<<<<<<<<<<<<<
 *             raise ValueError('When "C" is given, "B" should also be given.')
 ...
 */
    ...
    if (unlikely(__pyx_t_4)) {
      ...
      /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":69
 *     if C is not None:
 *         if B is None:
 *             raise ValueError('When "C" is given, "B" should also be given.')             # <<<<<<<<<<<<<<
 *         if (isinstance(A, numpy.ndarray)) and \
 ...
 */
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":70
 *         if B is None:
 *             raise ValueError('When "C" is given, "B" should also be given.')
 *         if (isinstance(A, numpy.ndarray)) and \             # <<<<<<<<<<<<<<
 *                 (not isinstance(C, numpy.ndarray)):
 ...
 */
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":71
 *             raise ValueError('When "C" is given, "B" should also be given.')
 *         if (isinstance(A, numpy.ndarray)) and \
 *                 (not isinstance(C, numpy.ndarray)):             # <<<<<<<<<<<<<<
 *             raise TypeError('When the input matrix "A" is of type ' +
 ...
 */
    ...
    if (unlikely(__pyx_t_4)) {
      ...
      /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":72
 *         if (isinstance(A, numpy.ndarray)) and \
 *                 (not isinstance(C, numpy.ndarray)):
 *             raise TypeError('When the input matrix "A" is of type ' +             # <<<<<<<<<<<<<<
 *                             '"numpy.ndarray", matrix "C" should also be of ' +
 ...
 */
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":75
 *                             '"numpy.ndarray", matrix "C" should also be of ' +
 *                             'the same type.')
 ...
 */
    ...
    if (unlikely(__pyx_t_4)) {
      ...
      /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":76
 *                             'the same type.')
 *         if isspmatrix(A) and not isspmatrix(C):
 *             raise TypeError('When the input matrix "A" is of type ' +             # <<<<<<<<<<<<<<
 *                             '"scipy.sparse", matrix "C" should also be of ' +
 ...
 */
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":79
 *                             '"scipy.sparse", matrix "C" should also be of ' +
 *                             'the same type.')
 ...
 */
    ...
    if (unlikely(__pyx_t_4)) {
      ...
      /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":80
 *                             'the same type.')
 *         elif A.shape != C.shape:
 *             raise ValueError('Matrix "C" should have the same size as ' +             # <<<<<<<<<<<<<<
 *                              'matrix "A".')
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":84
 * 
 *     # Check gram
 *     if gram is None:             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (unlikely(__pyx_t_1)) {
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":85
 *     # Check gram
 *     if gram is None:
 *         raise TypeError('"gram" cannot be None.')             # <<<<<<<<<<<<<<
 *     elif not numpy.isscalar(gram):
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":86
 *     if gram is None:
 *         raise TypeError('"gram" cannot be None.')
 *     elif not numpy.isscalar(gram):             # <<<<<<<<<<<<<<
 *         raise TypeError('"gram" should be a scalar value.')
 ...
 */
  ...
  if (unlikely(__pyx_t_4)) {
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":87
 *         raise TypeError('"gram" cannot be None.')
 *     elif not numpy.isscalar(gram):
 *         raise TypeError('"gram" should be a scalar value.')             # <<<<<<<<<<<<<<
 *     elif not isinstance(gram, bool):
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":88
 *     elif not numpy.isscalar(gram):
 *         raise TypeError('"gram" should be a scalar value.')
 *     elif not isinstance(gram, bool):             # <<<<<<<<<<<<<<
 *         raise TypeError('"gram" should be boolean.')
 ...
 */
  ...
  if (unlikely(__pyx_t_1)) {
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":89
 *         raise TypeError('"gram" should be a scalar value.')
 *     elif not isinstance(gram, bool):
 *         raise TypeError('"gram" should be boolean.')             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":92
 * 
 *     # Check exponent
 *     if exponent is None:             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (unlikely(__pyx_t_4)) {
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":93
 *     # Check exponent
 *     if exponent is None:
 *         raise TypeError('"exponent" cannot be None.')             # <<<<<<<<<<<<<<
 *     elif not numpy.isscalar(exponent):
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":94
 *     if exponent is None:
 *         raise TypeError('"exponent" cannot be None.')
 *     elif not numpy.isscalar(exponent):             # <<<<<<<<<<<<<<
 *         raise TypeError('"exponent" should be a scalar value.')
 ...
 */
  ...
  if (unlikely(__pyx_t_1)) {
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":95
 *         raise TypeError('"exponent" cannot be None.')
 *     elif not numpy.isscalar(exponent):
 *         raise TypeError('"exponent" should be a scalar value.')             # <<<<<<<<<<<<<<
 *     elif not isinstance(exponent, (int, numpy.integer)):
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":96
 *     elif not numpy.isscalar(exponent):
 *         raise TypeError('"exponent" should be a scalar value.')
 *     elif not isinstance(exponent, (int, numpy.integer)):             # <<<<<<<<<<<<<<
 *         TypeError('"exponent" cannot be an integer.')
 ...
 */
  ...
  if (__pyx_t_4) {
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":97
 *         raise TypeError('"exponent" should be a scalar value.')
 *     elif not isinstance(exponent, (int, numpy.integer)):
 *         TypeError('"exponent" cannot be an integer.')             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":100
 * 
 *     # Check assume_matrix
 ...
 */
  ...
  if (unlikely(__pyx_t_1)) {
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":101
 *     # Check assume_matrix
 *     if assume_matrix is None:
 *         raise ValueError('"assume_matrix" cannot be None.')             # <<<<<<<<<<<<<<
 *     elif not isinstance(assume_matrix, str):
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":102
 *     if assume_matrix is None:
 *         raise ValueError('"assume_matrix" cannot be None.')
 *     elif not isinstance(assume_matrix, str):             # <<<<<<<<<<<<<<
 *         raise TypeError('"assume_matrix" must be a string.')
 ...
 */
  ...
  if (unlikely(__pyx_t_4)) {
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":103
 *         raise ValueError('"assume_matrix" cannot be None.')
 *     elif not isinstance(assume_matrix, str):
 *         raise TypeError('"assume_matrix" must be a string.')             # <<<<<<<<<<<<<<
 *     elif assume_matrix != 'gen' and assume_matrix != "pos" and \
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":104
 *     elif not isinstance(assume_matrix, str):
 *         raise TypeError('"assume_matrix" must be a string.')
 *     elif assume_matrix != 'gen' and assume_matrix != "pos" and \             # <<<<<<<<<<<<<<
 *             assume_matrix != "sym" and assume_matrix != "sym_pos":
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":105
 *         raise TypeError('"assume_matrix" must be a string.')
 *     elif assume_matrix != 'gen' and assume_matrix != "pos" and \
 *             assume_matrix != "sym" and assume_matrix != "sym_pos":             # <<<<<<<<<<<<<<
 *         raise ValueError('"assume_matrix" should be either "gen", "pos", ' +
 ...
 */
  ...
  if (unlikely(__pyx_t_4)) {
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":106
 *     elif assume_matrix != 'gen' and assume_matrix != "pos" and \
 *             assume_matrix != "sym" and assume_matrix != "sym_pos":
 *         raise ValueError('"assume_matrix" should be either "gen", "pos", ' +             # <<<<<<<<<<<<<<
 *                          '"sym, or "sym_pos".')
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":110
 * 
 ...
 */
  ...
  if (unlikely(__pyx_t_1)) {
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":111
 *     # Check min_num_samples
 *     if min_num_samples is None:
 *         raise ValueError('"min_num_samples" cannot be None.')             # <<<<<<<<<<<<<<
 *     elif not numpy.isscalar(min_num_samples):
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":112
 *     if min_num_samples is None:
 *         raise ValueError('"min_num_samples" cannot be None.')
 *     elif not numpy.isscalar(min_num_samples):             # <<<<<<<<<<<<<<
 *         raise TypeError('"min_num_samples" should be a scalar value.')
 ...
 */
  ...
  if (unlikely(__pyx_t_4)) {
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":113
 *         raise ValueError('"min_num_samples" cannot be None.')
 *     elif not numpy.isscalar(min_num_samples):
 *         raise TypeError('"min_num_samples" should be a scalar value.')             # <<<<<<<<<<<<<<
 *     elif not isinstance(min_num_samples, (int, numpy.integer)):
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":114
 *     elif not numpy.isscalar(min_num_samples):
 *         raise TypeError('"min_num_samples" should be a scalar value.')
 *     elif not isinstance(min_num_samples, (int, numpy.integer)):             # <<<<<<<<<<<<<<
 *         raise TypeError('"min_num_samples" should be an integer.')
 ...
 */
  ...
  if (unlikely(__pyx_t_1)) {
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":115
 *         raise TypeError('"min_num_samples" should be a scalar value.')
 *     elif not isinstance(min_num_samples, (int, numpy.integer)):
 *         raise TypeError('"min_num_samples" should be an integer.')             # <<<<<<<<<<<<<<
 *     elif min_num_samples < 1:
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":116
 *     elif not isinstance(min_num_samples, (int, numpy.integer)):
 *         raise TypeError('"min_num_samples" should be an integer.')
 *     elif min_num_samples < 1:             # <<<<<<<<<<<<<<
 *         raise ValueError('"min_num_samples" should be at least one.')
 ...
 */
  ...
  if (unlikely(__pyx_t_1)) {
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":117
 *         raise TypeError('"min_num_samples" should be an integer.')
 *     elif min_num_samples < 1:
 *         raise ValueError('"min_num_samples" should be at least one.')             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":120
 * 
 *     # Check max_num_samples
 ...
 */
  ...
  if (unlikely(__pyx_t_4)) {
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":121
 *     # Check max_num_samples
 *     if max_num_samples is None:
 *         raise ValueError('"max_num_samples" cannot be None.')             # <<<<<<<<<<<<<<
 *     elif not numpy.isscalar(max_num_samples):
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":122
 *     if max_num_samples is None:
 *         raise ValueError('"max_num_samples" cannot be None.')
 *     elif not numpy.isscalar(max_num_samples):             # <<<<<<<<<<<<<<
 *         raise TypeError('"max_num_samples" should be a scalar value.')
 ...
 */
  ...
  if (unlikely(__pyx_t_1)) {
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":123
 *         raise ValueError('"max_num_samples" cannot be None.')
 *     elif not numpy.isscalar(max_num_samples):
 *         raise TypeError('"max_num_samples" should be a scalar value.')             # <<<<<<<<<<<<<<
 *     elif not isinstance(max_num_samples, (int, numpy.integer)):
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":124
 *     elif not numpy.isscalar(max_num_samples):
 *         raise TypeError('"max_num_samples" should be a scalar value.')
 *     elif not isinstance(max_num_samples, (int, numpy.integer)):             # <<<<<<<<<<<<<<
 *         raise TypeError('"max_num_samples" should be an integer.')
 ...
 */
  ...
  if (unlikely(__pyx_t_4)) {
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":125
 *         raise TypeError('"max_num_samples" should be a scalar value.')
 *     elif not isinstance(max_num_samples, (int, numpy.integer)):
 *         raise TypeError('"max_num_samples" should be an integer.')             # <<<<<<<<<<<<<<
 *     elif max_num_samples < 1:
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":126
 *     elif not isinstance(max_num_samples, (int, numpy.integer)):
 *         raise TypeError('"max_num_samples" should be an integer.')
 *     elif max_num_samples < 1:             # <<<<<<<<<<<<<<
 *         raise ValueError('"max_num_samples" should be at least one.')
 ...
 */
  ...
  if (unlikely(__pyx_t_4)) {
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":127
 *         raise TypeError('"max_num_samples" should be an integer.')
 *     elif max_num_samples < 1:
 *         raise ValueError('"max_num_samples" should be at least one.')             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":130
 * 
 *     # Check min and max num samples
 ...
 */
  ...
  if (unlikely(__pyx_t_4)) {
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":131
 *     # Check min and max num samples
 *     if min_num_samples > max_num_samples:
 *         raise ValueError('"min_num_samples" cannot be greater than ' +             # <<<<<<<<<<<<<<
 *                          '"max_num_samples".')
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":135
 * 
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":136
 *     # Check convergence absolute tolerance
 *     if error_atol is None:
 *         error_atol = 0.0             # <<<<<<<<<<<<<<
 *     elif not numpy.isscalar(error_atol):
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":137
 *     if error_atol is None:
 *         error_atol = 0.0
 *     elif not numpy.isscalar(error_atol):             # <<<<<<<<<<<<<<
 *         raise TypeError('"error_atol" should be a scalar value.')
 ...
 */
  ...
  if (unlikely(__pyx_t_4)) {
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":138
 *         error_atol = 0.0
 *     elif not numpy.isscalar(error_atol):
 *         raise TypeError('"error_atol" should be a scalar value.')             # <<<<<<<<<<<<<<
 *     elif not isinstance(error_atol, (int, numpy.integer, float)):
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":139
 *     elif not numpy.isscalar(error_atol):
 *         raise TypeError('"error_atol" should be a scalar value.')
 *     elif not isinstance(error_atol, (int, numpy.integer, float)):             # <<<<<<<<<<<<<<
 *         raise TypeError('"error_atol" should be a float number.')
 ...
 */
  ...
  if (unlikely(__pyx_t_5)) {
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":140
 *         raise TypeError('"error_atol" should be a scalar value.')
 *     elif not isinstance(error_atol, (int, numpy.integer, float)):
 *         raise TypeError('"error_atol" should be a float number.')             # <<<<<<<<<<<<<<
 *     elif error_atol < 0.0:
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":141
 *     elif not isinstance(error_atol, (int, numpy.integer, float)):
 *         raise TypeError('"error_atol" should be a float number.')
 *     elif error_atol < 0.0:             # <<<<<<<<<<<<<<
 *         raise ValueError('"error_atol" cannot be negative.')
 ...
 */
  ...
  if (unlikely(__pyx_t_5)) {
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":142
 *         raise TypeError('"error_atol" should be a float number.')
 *     elif error_atol < 0.0:
 *         raise ValueError('"error_atol" cannot be negative.')             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":145
 * 
 *     # Check error relative tolerance
 ...
 */
  ...
  if (__pyx_t_4) {
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":146
 *     # Check error relative tolerance
 *     if error_rtol is None:
 *         error_rtol = 0.0             # <<<<<<<<<<<<<<
 *     elif not numpy.isscalar(error_rtol):
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":147
 *     if error_rtol is None:
 *         error_rtol = 0.0
 *     elif not numpy.isscalar(error_rtol):             # <<<<<<<<<<<<<<
 *         raise TypeError('"error_rtol" should be a scalar value.')
 ...
 */
  ...
  if (unlikely(__pyx_t_5)) {
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":148
 *         error_rtol = 0.0
 *     elif not numpy.isscalar(error_rtol):
 *         raise TypeError('"error_rtol" should be a scalar value.')             # <<<<<<<<<<<<<<
 *     elif not isinstance(error_rtol, (int, numpy.integer, float)):
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":149
 *     elif not numpy.isscalar(error_rtol):
 *         raise TypeError('"error_rtol" should be a scalar value.')
 *     elif not isinstance(error_rtol, (int, numpy.integer, float)):             # <<<<<<<<<<<<<<
 *         raise TypeError('"error_rtol" should be a float number.')
 ...
 */
  ...
  if (unlikely(__pyx_t_1)) {
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":150
 *         raise TypeError('"error_rtol" should be a scalar value.')
 *     elif not isinstance(error_rtol, (int, numpy.integer, float)):
 *         raise TypeError('"error_rtol" should be a float number.')             # <<<<<<<<<<<<<<
 *     elif error_rtol < 0.0:
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":151
 *     elif not isinstance(error_rtol, (int, numpy.integer, float)):
 *         raise TypeError('"error_rtol" should be a float number.')
 *     elif error_rtol < 0.0:             # <<<<<<<<<<<<<<
 *         raise ValueError('"error_rtol" cannot be negative.')
 ...
 */
  ...
  if (unlikely(__pyx_t_1)) {
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":152
 *         raise TypeError('"error_rtol" should be a float number.')
 *     elif error_rtol < 0.0:
 *         raise ValueError('"error_rtol" cannot be negative.')             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":155
 * 
 *     # Check confidence level
 ...
 */
  ...
  if (unlikely(__pyx_t_5)) {
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":156
 *     # Check confidence level
 *     if confidence_level is None:
 *         raise TypeError('"confidence_level" cannot be None.')             # <<<<<<<<<<<<<<
 *     elif not numpy.isscalar(confidence_level):
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":157
 *     if confidence_level is None:
 *         raise TypeError('"confidence_level" cannot be None.')
 *     elif not numpy.isscalar(confidence_level):             # <<<<<<<<<<<<<<
 *         raise TypeError('"confidence_level" should be a scalar.')
 ...
 */
  ...
  if (unlikely(__pyx_t_1)) {
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":158
 *         raise TypeError('"confidence_level" cannot be None.')
 *     elif not numpy.isscalar(confidence_level):
 *         raise TypeError('"confidence_level" should be a scalar.')             # <<<<<<<<<<<<<<
 *     elif not isinstance(confidence_level, (int, numpy.integer, float)):
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":159
 *     elif not numpy.isscalar(confidence_level):
 *         raise TypeError('"confidence_level" should be a scalar.')
 *     elif not isinstance(confidence_level, (int, numpy.integer, float)):             # <<<<<<<<<<<<<<
 *         raise TypeError('"confidence_level" should be a float number.')
 ...
 */
  ...
  if (unlikely(__pyx_t_4)) {
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":160
 *         raise TypeError('"confidence_level" should be a scalar.')
 *     elif not isinstance(confidence_level, (int, numpy.integer, float)):
 *         raise TypeError('"confidence_level" should be a float number.')             # <<<<<<<<<<<<<<
 *     elif confidence_level < 0.0 or confidence_level > 1.0:
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":161
 *     elif not isinstance(confidence_level, (int, numpy.integer, float)):
 *         raise TypeError('"confidence_level" should be a float number.')
 *     elif confidence_level < 0.0 or confidence_level > 1.0:             # <<<<<<<<<<<<<<
 *         raise ValueError('"confidence_level" should be between 0 and 1.')
 ...
 */
  ...
  if (unlikely(__pyx_t_4)) {
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":162
 *         raise TypeError('"confidence_level" should be a float number.')
 *     elif confidence_level < 0.0 or confidence_level > 1.0:
 *         raise ValueError('"confidence_level" should be between 0 and 1.')             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":165
 * 
 *     # Check outlier significance level
 ...
 */
  ...
  if (unlikely(__pyx_t_1)) {
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":166
 *     # Check outlier significance level
 *     if outlier_significance_level is None:
 *         raise TypeError('"outlier_significance_level" cannot be None.')             # <<<<<<<<<<<<<<
 *     elif not numpy.isscalar(outlier_significance_level):
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":167
 *     if outlier_significance_level is None:
 *         raise TypeError('"outlier_significance_level" cannot be None.')
 *     elif not numpy.isscalar(outlier_significance_level):             # <<<<<<<<<<<<<<
 *         raise TypeError('"outlier_significance_level" should be a scalar.')
 ...
 */
  ...
  if (unlikely(__pyx_t_4)) {
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":168
 *         raise TypeError('"outlier_significance_level" cannot be None.')
 *     elif not numpy.isscalar(outlier_significance_level):
 *         raise TypeError('"outlier_significance_level" should be a scalar.')             # <<<<<<<<<<<<<<
 *     elif not isinstance(outlier_significance_level,
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":170
 *         raise TypeError('"outlier_significance_level" should be a scalar.')
 *     elif not isinstance(outlier_significance_level,
 *                         (int, numpy.integer, float)):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":169
 *     elif not numpy.isscalar(outlier_significance_level):
 *         raise TypeError('"outlier_significance_level" should be a scalar.')
 *     elif not isinstance(outlier_significance_level,             # <<<<<<<<<<<<<<
 *                         (int, numpy.integer, float)):
 ...
 */
  ...
  if (unlikely(__pyx_t_5)) {
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":171
 *     elif not isinstance(outlier_significance_level,
 *                         (int, numpy.integer, float)):
 *         raise TypeError('"outlier_significance_level" must be a float number.')             # <<<<<<<<<<<<<<
 *     elif outlier_significance_level < 0.0 or outlier_significance_level > 1.0:
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":172
 *                         (int, numpy.integer, float)):
 *         raise TypeError('"outlier_significance_level" must be a float number.')
 *     elif outlier_significance_level < 0.0 or outlier_significance_level > 1.0:             # <<<<<<<<<<<<<<
 *         raise ValueError(
 ...
 */
  ...
  if (unlikely(__pyx_t_5)) {
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":173
 *         raise TypeError('"outlier_significance_level" must be a float number.')
 *     elif outlier_significance_level < 0.0 or outlier_significance_level > 1.0:
 *         raise ValueError(             # <<<<<<<<<<<<<<
 *                 '"outlier_significance_level" must be in [0, 1] interval.')
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":177
 * 
 ...
 */
  ...
  if (unlikely(__pyx_t_5)) {
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":178
 *     # Compare outlier significance level and confidence level
 *     if outlier_significance_level > 1.0 - confidence_level:
 *         raise ValueError('The sum of "confidence_level" and ' +             # <<<<<<<<<<<<<<
 *                          '"outlier_significance_level" should be less than 1.')
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":182
 * 
 *     # Check solver tol
 ...
 */
  ...
  if (unlikely(__pyx_t_5)) {
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":183
 *     # Check solver tol
 *     if solver_tol is not None and not numpy.isscalar(solver_tol):
 *         raise TypeError('"solver_tol" should be a scalar value.')             # <<<<<<<<<<<<<<
 *     elif solver_tol is not None and \
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":184
 *     if solver_tol is not None and not numpy.isscalar(solver_tol):
 *         raise TypeError('"solver_tol" should be a scalar value.')
 *     elif solver_tol is not None and \             # <<<<<<<<<<<<<<
 *             not isinstance(solver_tol, (int, numpy.integer, float)):
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":185
 *         raise TypeError('"solver_tol" should be a scalar value.')
 *     elif solver_tol is not None and \
 *             not isinstance(solver_tol, (int, numpy.integer, float)):             # <<<<<<<<<<<<<<
 *         raise TypeError('"solver_tol" should be a float number.')
 ...
 */
  ...
  if (unlikely(__pyx_t_5)) {
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":186
 *     elif solver_tol is not None and \
 *             not isinstance(solver_tol, (int, numpy.integer, float)):
 *         raise TypeError('"solver_tol" should be a float number.')             # <<<<<<<<<<<<<<
 *     elif solver_tol is not None and solver_tol < 0.0:
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":187
 *             not isinstance(solver_tol, (int, numpy.integer, float)):
 *         raise TypeError('"solver_tol" should be a float number.')
 *     elif solver_tol is not None and solver_tol < 0.0:             # <<<<<<<<<<<<<<
 *         raise ValueError('"lancozs_tol" cannot be negative.')
 ...
 */
  ...
  if (unlikely(__pyx_t_5)) {
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":188
 *         raise TypeError('"solver_tol" should be a float number.')
 *     elif solver_tol is not None and solver_tol < 0.0:
 *         raise ValueError('"lancozs_tol" cannot be negative.')             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":191
 * 
 *     # Check orthogonalize
 ...
 */
  ...
  if (unlikely(__pyx_t_1)) {
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":192
 *     # Check orthogonalize
 *     if orthogonalize is None:
 *         raise TypeError('"orthogonalize" cannot be None.')             # <<<<<<<<<<<<<<
 *     elif not numpy.isscalar(orthogonalize):
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":193
 *     if orthogonalize is None:
 *         raise TypeError('"orthogonalize" cannot be None.')
 *     elif not numpy.isscalar(orthogonalize):             # <<<<<<<<<<<<<<
 *         raise TypeError('"orthogonalize" should be a scalar value.')
 ...
 */
  ...
  if (unlikely(__pyx_t_5)) {
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":194
 *         raise TypeError('"orthogonalize" cannot be None.')
 *     elif not numpy.isscalar(orthogonalize):
 *         raise TypeError('"orthogonalize" should be a scalar value.')             # <<<<<<<<<<<<<<
 *     elif not isinstance(orthogonalize, bool):
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":195
 *     elif not numpy.isscalar(orthogonalize):
 *         raise TypeError('"orthogonalize" should be a scalar value.')
 *     elif not isinstance(orthogonalize, bool):             # <<<<<<<<<<<<<<
 *         raise TypeError('"orthogonalize" should be boolean.')
 ...
 */
  ...
  if (unlikely(__pyx_t_1)) {
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":196
 *         raise TypeError('"orthogonalize" should be a scalar value.')
 *     elif not isinstance(orthogonalize, bool):
 *         raise TypeError('"orthogonalize" should be boolean.')             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":199
 * 
 *     # Check num_threads
 ...
 */
  ...
  if (unlikely(__pyx_t_5)) {
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":200
 *     # Check num_threads
 *     if num_threads is None:
 *         raise TypeError('"num_threads" cannot be None.')             # <<<<<<<<<<<<<<
 *     elif not numpy.isscalar(num_threads):
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":201
 *     if num_threads is None:
 *         raise TypeError('"num_threads" cannot be None.')
 *     elif not numpy.isscalar(num_threads):             # <<<<<<<<<<<<<<
 *         raise TypeError('"num_threads" should be a scalar value.')
 ...
 */
  ...
  if (unlikely(__pyx_t_1)) {
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":202
 *         raise TypeError('"num_threads" cannot be None.')
 *     elif not numpy.isscalar(num_threads):
 *         raise TypeError('"num_threads" should be a scalar value.')             # <<<<<<<<<<<<<<
 *     elif not isinstance(num_threads, (int, numpy.integer)):
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":203
 *     elif not numpy.isscalar(num_threads):
 *         raise TypeError('"num_threads" should be a scalar value.')
 *     elif not isinstance(num_threads, (int, numpy.integer)):             # <<<<<<<<<<<<<<
 *         raise TypeError('"num_threads" should be an integer.')
 ...
 */
  ...
  if (unlikely(__pyx_t_5)) {
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":204
 *         raise TypeError('"num_threads" should be a scalar value.')
 *     elif not isinstance(num_threads, (int, numpy.integer)):
 *         raise TypeError('"num_threads" should be an integer.')             # <<<<<<<<<<<<<<
 *     elif num_threads < 0:
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":205
 *     elif not isinstance(num_threads, (int, numpy.integer)):
 *         raise TypeError('"num_threads" should be an integer.')
 *     elif num_threads < 0:             # <<<<<<<<<<<<<<
 *         raise ValueError('"num_threads" should be a non-negative integer.')
 ...
 */
  ...
  if (unlikely(__pyx_t_5)) {
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":206
 *         raise TypeError('"num_threads" should be an integer.')
 *     elif num_threads < 0:
 *         raise ValueError('"num_threads" should be a non-negative integer.')             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":209
 * 
 *     # Check verbose
 *     if verbose is None:             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (unlikely(__pyx_t_1)) {
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":210
 *     # Check verbose
 *     if verbose is None:
 *         raise TypeError('"verbose" cannot be None.')             # <<<<<<<<<<<<<<
 *     elif not numpy.isscalar(verbose):
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":211
 *     if verbose is None:
 *         raise TypeError('"verbose" cannot be None.')
 *     elif not numpy.isscalar(verbose):             # <<<<<<<<<<<<<<
 *         raise TypeError('"verbose" should be a scalar value.')
 ...
 */
  ...
  if (unlikely(__pyx_t_5)) {
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":212
 *         raise TypeError('"verbose" cannot be None.')
 *     elif not numpy.isscalar(verbose):
 *         raise TypeError('"verbose" should be a scalar value.')             # <<<<<<<<<<<<<<
 *     elif not isinstance(verbose, bool):
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":213
 *     elif not numpy.isscalar(verbose):
 *         raise TypeError('"verbose" should be a scalar value.')
 *     elif not isinstance(verbose, bool):             # <<<<<<<<<<<<<<
 *         raise TypeError('"verbose" should be boolean.')
 ...
 */
  ...
  if (unlikely(__pyx_t_1)) {
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":214
 *         raise TypeError('"verbose" should be a scalar value.')
 *     elif not isinstance(verbose, bool):
 *         raise TypeError('"verbose" should be boolean.')             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":217
 * 
 *     # Check plot
 *     if plot is None:             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (unlikely(__pyx_t_5)) {
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":218
 *     # Check plot
 *     if plot is None:
 *         raise TypeError('"plot" cannot be None.')             # <<<<<<<<<<<<<<
 *     elif not numpy.isscalar(plot):
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":219
 *     if plot is None:
 *         raise TypeError('"plot" cannot be None.')
 *     elif not numpy.isscalar(plot):             # <<<<<<<<<<<<<<
 *         raise TypeError('"plot" should be a scalar value.')
 ...
 */
  ...
  if (unlikely(__pyx_t_1)) {
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":220
 *         raise TypeError('"plot" cannot be None.')
 *     elif not numpy.isscalar(plot):
 *         raise TypeError('"plot" should be a scalar value.')             # <<<<<<<<<<<<<<
 *     elif not isinstance(plot, bool):
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":221
 *     elif not numpy.isscalar(plot):
 *         raise TypeError('"plot" should be a scalar value.')
 *     elif not isinstance(plot, bool):             # <<<<<<<<<<<<<<
 *         raise TypeError('"plot" should be boolean.')
 ...
 */
  ...
  if (unlikely(__pyx_t_5)) {
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":222
 *         raise TypeError('"plot" should be a scalar value.')
 *     elif not isinstance(plot, bool):
 *         raise TypeError('"plot" should be boolean.')             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":225
 * 
 *     # Check if plot modules exist
 *     if plot is True:             # <<<<<<<<<<<<<<
 *         try:
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":226
 *     # Check if plot modules exist
 *     if plot is True:
 *         try:             # <<<<<<<<<<<<<<
 *             from .._utilities.plot_utilities import matplotlib      # noqa F401
 ...
 */
    __Pyx_TraceLine(226,0,__PYX_ERR(0, 226, __pyx_L1_error))
    {
      ...
      /*try:*/ {
        ...
        /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":227
 *     if plot is True:
 *         try:
 *             from .._utilities.plot_utilities import matplotlib      # noqa F401             # <<<<<<<<<<<<<<
 *             from .._utilities.plot_utilities import load_plot_settings
 ...
 */
        ...
        /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":228
 *         try:
 *             from .._utilities.plot_utilities import matplotlib      # noqa F401
 *             from .._utilities.plot_utilities import load_plot_settings             # <<<<<<<<<<<<<<
 *             load_plot_settings()
 ...
 */
        ...
        /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":229
 *             from .._utilities.plot_utilities import matplotlib      # noqa F401
 *             from .._utilities.plot_utilities import load_plot_settings
 *             load_plot_settings()             # <<<<<<<<<<<<<<
 *         except ImportError:
 ...
 */
      ...
      /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":230
 *             from .._utilities.plot_utilities import load_plot_settings
 *             load_plot_settings()
 *         except ImportError:             # <<<<<<<<<<<<<<
 *             raise ImportError('Cannot import modules for plotting. Either ' +
 ...
 */
      ...
      if (__pyx_t_11) {
        ...
        /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":231
 *             load_plot_settings()
 *         except ImportError:
 *             raise ImportError('Cannot import modules for plotting. Either ' +             # <<<<<<<<<<<<<<
 *                               'install "matplotlib" and "seaborn" packages, ' +
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":235
 *                               'or set "plot=False".')
 * 
...
/* "pyrand/traceinv/_hutchinson_method_utilities.pyx":242
 * # =============
 * 
...
/* Python wrapper */
static PyObject *__pyx_pw_6pyrand_8traceinv_28_hutchinson_method_utilities_3print_summary(PyObject *__pyx_self, PyObject *__pyx_v_info); /*proto*/
static char __pyx_doc_6pyrand_8traceinv_28_hutchinson_method_utilities_2print_summary[] = "print_summary(info)\n\n    ";
static PyMethodDef __pyx_mdef_6pyrand_8traceinv_28_hutchinson_method_utilities_3print_summary = {"print_summary", (PyCFunction)__pyx_pw_6pyrand_8traceinv_28_hutchinson_method_utilities_3print_summary, METH_O, __pyx_doc_6pyrand_8traceinv_28_hutchinson_method_utilities_2print_summary};
static PyObject *__pyx_pw_6pyrand_8traceinv_28_hutchinson_method_utilities_3print_summary(PyObject *__pyx_self, PyObject *__pyx_v_info) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("print_summary (wrapper)", 0);
  __pyx_r = __pyx_pf_6pyrand_8traceinv_28_hutchinson_method_utilities_2print_summary(__pyx_self, ((PyObject *)__pyx_v_info));
...
static PyObject *__pyx_pf_6pyrand_8traceinv_28_hutchinson_method_utilities_2print_summary(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_info) {
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":247
 * 
 *     # Matrix info
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":248
 *     # Matrix info
 *     data_type = info['matrix']['data_type'].decode("utf-8")
 *     gram = info['matrix']['gram']             # <<<<<<<<<<<<<<
 *     exponent = info['matrix']['exponent']
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":249
 *     data_type = info['matrix']['data_type'].decode("utf-8")
 *     gram = info['matrix']['gram']
 *     exponent = info['matrix']['exponent']             # <<<<<<<<<<<<<<
 *     assume_matrix = info['matrix']['assume_matrix']
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":250
 *     gram = info['matrix']['gram']
 *     exponent = info['matrix']['exponent']
 *     assume_matrix = info['matrix']['assume_matrix']             # <<<<<<<<<<<<<<
 *     num_inquiries = info['matrix']['num_inquiries']
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":251
 *     exponent = info['matrix']['exponent']
 *     assume_matrix = info['matrix']['assume_matrix']
 *     num_inquiries = info['matrix']['num_inquiries']             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":254
 * 
 *     # Error info
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":255
 *     # Error info
 *     absolute_error = info['error']['absolute_error']
 *     relative_error = info['error']['relative_error'] * 100.0             # <<<<<<<<<<<<<<
 *     error_atol = info['error']['error_atol']
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":256
 *     absolute_error = info['error']['absolute_error']
 *     relative_error = info['error']['relative_error'] * 100.0
 *     error_atol = info['error']['error_atol']             # <<<<<<<<<<<<<<
 *     error_rtol = info['error']['error_rtol'] * 100.0
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":257
 *     relative_error = info['error']['relative_error'] * 100.0
 *     error_atol = info['error']['error_atol']
 *     error_rtol = info['error']['error_rtol'] * 100.0             # <<<<<<<<<<<<<<
 *     confidence_level = info['error']['confidence_level'] * 100.0
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":258
 *     error_atol = info['error']['error_atol']
 *     error_rtol = info['error']['error_rtol'] * 100.0
 *     confidence_level = info['error']['confidence_level'] * 100.0             # <<<<<<<<<<<<<<
 *     outlier_significance_level = info['error']['outlier_significance_level']
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":259
 *     error_rtol = info['error']['error_rtol'] * 100.0
 *     confidence_level = info['error']['confidence_level'] * 100.0
 *     outlier_significance_level = info['error']['outlier_significance_level']             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":262
 * 
 *     # Convergence info
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":263
 *     # Convergence info
 *     num_samples_used = info['convergence']['num_samples_used']
 *     num_outliers = info['convergence']['num_outliers']             # <<<<<<<<<<<<<<
 *     min_num_samples = info['convergence']['min_num_samples']
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":264
 *     num_samples_used = info['convergence']['num_samples_used']
 *     num_outliers = info['convergence']['num_outliers']
 *     min_num_samples = info['convergence']['min_num_samples']             # <<<<<<<<<<<<<<
 *     max_num_samples = info['convergence']['max_num_samples']
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":265
 *     num_outliers = info['convergence']['num_outliers']
 *     min_num_samples = info['convergence']['min_num_samples']
 *     max_num_samples = info['convergence']['max_num_samples']             # <<<<<<<<<<<<<<
 *     converged = info['convergence']['converged']
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":266
 *     min_num_samples = info['convergence']['min_num_samples']
 *     max_num_samples = info['convergence']['max_num_samples']
 *     converged = info['convergence']['converged']             # <<<<<<<<<<<<<<
 *     trace = info['convergence']['samples_mean']
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":267
 *     max_num_samples = info['convergence']['max_num_samples']
 *     converged = info['convergence']['converged']
 *     trace = info['convergence']['samples_mean']             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":270
 * 
 *     # time
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":271
 *     # time
 *     tot_wall_time = info['time']['tot_wall_time']
 *     alg_wall_time = info['time']['alg_wall_time']             # <<<<<<<<<<<<<<
 *     cpu_proc_time = info['time']['cpu_proc_time']
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":272
 *     tot_wall_time = info['time']['tot_wall_time']
 *     alg_wall_time = info['time']['alg_wall_time']
 *     cpu_proc_time = info['time']['cpu_proc_time']             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":275
 * 
 *     # device
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":276
 *     # device
 *     num_cpu_threads = info['device']['num_cpu_threads']
 *     num_gpu_devices = info['device']['num_gpu_devices']             # <<<<<<<<<<<<<<
 *     num_gpu_multiprocessors = info['device']['num_gpu_multiprocessors']
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":277
 *     num_cpu_threads = info['device']['num_cpu_threads']
 *     num_gpu_devices = info['device']['num_gpu_devices']
 *     num_gpu_multiprocessors = info['device']['num_gpu_multiprocessors']             # <<<<<<<<<<<<<<
 *     num_gpu_threads_per_multiprocessor = \
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":279
 *     num_gpu_multiprocessors = info['device']['num_gpu_multiprocessors']
 *     num_gpu_threads_per_multiprocessor = \
 *         info['device']['num_gpu_threads_per_multiprocessor']             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":282
 * 
 *     # Solver info
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":283
 *     # Solver info
 *     solver_tol = info['solver']['solver_tol']
 *     orthogonalize = info['solver']['orthogonalize']             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":286
 * 
 *     # Makes assume_matrix string more readable
 ...
 */
  ...
  if (__pyx_t_4) {
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":287
 *     # Makes assume_matrix string more readable
 *     if assume_matrix == "gen":
 *         assume_matrix = "generic"             # <<<<<<<<<<<<<<
 *     elif assume_matrix == "sym":
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":288
 *     if assume_matrix == "gen":
 *         assume_matrix = "generic"
 *     elif assume_matrix == "sym":             # <<<<<<<<<<<<<<
 *         assume_matrix = "symmetric"
 ...
 */
  ...
  if (__pyx_t_4) {
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":289
 *         assume_matrix = "generic"
 *     elif assume_matrix == "sym":
 *         assume_matrix = "symmetric"             # <<<<<<<<<<<<<<
 *     elif assume_matrix == "sym_pos":
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":290
 *     elif assume_matrix == "sym":
 *         assume_matrix = "symmetric"
 *     elif assume_matrix == "sym_pos":             # <<<<<<<<<<<<<<
 *         assume_matrix = "symmetric-positive"
 ...
 */
  ...
  if (likely(__pyx_t_4)) {
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":291
 *         assume_matrix = "symmetric"
 *     elif assume_matrix == "sym_pos":
 *         assume_matrix = "symmetric-positive"             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":293
 *         assume_matrix = "symmetric-positive"
 *     else:
 *         raise ValueError('"assume_matrix" is invalid.')             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":296
 * 
 *     # Convert data type to x-bit format
 ...
 */
  ...
  if (__pyx_t_4) {
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":297
 *     # Convert data type to x-bit format
 *     if data_type == 'float32':
 *         data_type_ = '32-bit'             # <<<<<<<<<<<<<<
 *     elif data_type == 'float64':
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":298
 *     if data_type == 'float32':
 *         data_type_ = '32-bit'
 *     elif data_type == 'float64':             # <<<<<<<<<<<<<<
 *         data_type_ = '64-bit'
 ...
 */
  ...
  if (likely(__pyx_t_4)) {
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":299
 *         data_type_ = '32-bit'
 *     elif data_type == 'float64':
 *         data_type_ = '64-bit'             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":301
 *         data_type_ = '64-bit'
 *     else:
 *         raise TypeError('"data_type" should be "float32" or "float64".')             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":304
 * 
 *     # Print results
 *     print('                                    results                      ' +             # <<<<<<<<<<<<<<
 *           '             ')
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":306
 *     print('                                    results                      ' +
 *           '             ')
 *     print('=================================================================' +             # <<<<<<<<<<<<<<
 *           '=============')
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":308
 *     print('=================================================================' +
 *           '=============')
 *     print('     inquiries                            error            sample' +             # <<<<<<<<<<<<<<
 *           's            ')
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":310
 *     print('     inquiries                            error            sample' +
 *           's            ')
 *     print('--------------------              ---------------------   -------' +             # <<<<<<<<<<<<<<
 *           '--           ')
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":312
 *     print('--------------------              ---------------------   -------' +
 *           '--           ')
 *     print('i         parameters       trace    absolute   relative   num   o' +             # <<<<<<<<<<<<<<
 *           'ut  converged')
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":314
 *     print('i         parameters       trace    absolute   relative   num   o' +
 *           'ut  converged')
 *     print('=================================================================' +             # <<<<<<<<<<<<<<
 *           '=============')
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":318
 * 
 ...
 */
  ...
  for (;;) {
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":321
 * 
 *         # Column "i"
 *         print('%-3d  ' % (i+1), end="")             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":324
 * 
 *         # Column "parameters"
 *         print(' %8s  none  ' % "", end="")             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":327
 * 
 *         # Data columns, depend whether has one or multiple rows (num_inquiries)
 *         if num_inquiries == 1:             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    if (__pyx_t_4) {
      ...
      /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":330
 * 
 *             # will print one row
 ...
 */
      ...
      if (__pyx_t_4) {
        ...
        /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":331
 *             # will print one row
 *             if numpy.isnan(trace) or numpy.isinf(trace):
 *                 print('%10e   ' % trace, end="")             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
      ...
      /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":333
 *                 print('%10e   ' % trace, end="")
 *             else:
 *                 print('%+7.3e   ' % trace, end="")             # <<<<<<<<<<<<<<
 ...
 */
      ...
      /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":334
 *             else:
 *                 print('%+7.3e   ' % trace, end="")
 *             if numpy.isnan(absolute_error) or numpy.isinf(absolute_error):             # <<<<<<<<<<<<<<
 *                 print('%9e  ' % absolute_error, end="")
 ...
 */
      ...
      if (__pyx_t_4) {
        ...
        /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":335
 *                 print('%+7.3e   ' % trace, end="")
 *             if numpy.isnan(absolute_error) or numpy.isinf(absolute_error):
 *                 print('%9e  ' % absolute_error, end="")             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
      ...
      /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":337
 *                 print('%9e  ' % absolute_error, end="")
 *             else:
 *                 print('%7.3e  ' % absolute_error, end="")             # <<<<<<<<<<<<<<
 ...
 */
      ...
      /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":338
 *             else:
 *                 print('%7.3e  ' % absolute_error, end="")
 *             if numpy.isnan(relative_error) or numpy.isinf(relative_error):             # <<<<<<<<<<<<<<
 *                 print('%9f  ' % relative_error, end="")
 ...
 */
      ...
      if (__pyx_t_4) {
        ...
        /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":339
 *                 print('%7.3e  ' % absolute_error, end="")
 *             if numpy.isnan(relative_error) or numpy.isinf(relative_error):
 *                 print('%9f  ' % relative_error, end="")             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
      ...
      /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":341
 *                 print('%9f  ' % relative_error, end="")
 *             else:
 *                 print('%8.3f%%  ' % relative_error, end="")             # <<<<<<<<<<<<<<
 ...
 */
      ...
      /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":342
 *             else:
 *                 print('%8.3f%%  ' % relative_error, end="")
 *             print('%4d  %4d' % (num_samples_used, num_outliers), end="")             # <<<<<<<<<<<<<<
 *             print('%11s' % converged)
 ...
 */
      ...
      /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":343
 *                 print('%8.3f%%  ' % relative_error, end="")
 *             print('%4d  %4d' % (num_samples_used, num_outliers), end="")
 *             print('%11s' % converged)             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":348
 * 
 ...
 */
    ...
    /*else*/ {
      ...
      if (__pyx_t_4) {
        ...
        /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":349
 *             # will print multiple rows
 *             if numpy.isnan(trace[i]) or numpy.isinf(trace[i]):
 *                 print('%10e  ' % trace[i], end="")             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
      ...
      /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":351
 *                 print('%10e  ' % trace[i], end="")
 *             else:
 *                 print('%+7.3e   ' % trace[i], end="")             # <<<<<<<<<<<<<<
 ...
 */
      ...
      /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":352
 *             else:
 *                 print('%+7.3e   ' % trace[i], end="")
 *             if numpy.isnan(absolute_error[i]) or \             # <<<<<<<<<<<<<<
 *                numpy.isinf(absolute_error[i]):
 ...
 */
      ...
      /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":353
 *                 print('%+7.3e   ' % trace[i], end="")
 *             if numpy.isnan(absolute_error[i]) or \
 *                numpy.isinf(absolute_error[i]):             # <<<<<<<<<<<<<<
 *                 print('%9e  ' % absolute_error[i], end="")
 ...
 */
      ...
      if (__pyx_t_4) {
        ...
        /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":354
 *             if numpy.isnan(absolute_error[i]) or \
 *                numpy.isinf(absolute_error[i]):
 *                 print('%9e  ' % absolute_error[i], end="")             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
      ...
      /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":356
 *                 print('%9e  ' % absolute_error[i], end="")
 *             else:
 *                 print('%7.3e  ' % absolute_error[i], end="")             # <<<<<<<<<<<<<<
 ...
 */
      ...
      /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":357
 *             else:
 *                 print('%7.3e  ' % absolute_error[i], end="")
 *             if numpy.isnan(relative_error[i]) or \             # <<<<<<<<<<<<<<
 *                numpy.isinf(relative_error[i]):
 ...
 */
      ...
      /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":358
 *                 print('%7.3e  ' % absolute_error[i], end="")
 *             if numpy.isnan(relative_error[i]) or \
 *                numpy.isinf(relative_error[i]):             # <<<<<<<<<<<<<<
 *                 print('%9f  ' % relative_error[i], end="")
 ...
 */
      ...
      if (__pyx_t_4) {
        ...
        /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":359
 *             if numpy.isnan(relative_error[i]) or \
 *                numpy.isinf(relative_error[i]):
 *                 print('%9f  ' % relative_error[i], end="")             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
      ...
      /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":361
 *                 print('%9f  ' % relative_error[i], end="")
 *             else:
 *                 print('%8.3f%%  ' % relative_error[i], end="")             # <<<<<<<<<<<<<<
 ...
 */
      ...
      /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":362
 *             else:
 *                 print('%8.3f%%  ' % relative_error[i], end="")
 *             print('%4d  %4d' % (num_samples_used[i], num_outliers[i]), end="")             # <<<<<<<<<<<<<<
 *             print('%11s' % converged[i])
 ...
 */
      ...
      /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":363
 *                 print('%8.3f%%  ' % relative_error[i], end="")
 *             print('%4d  %4d' % (num_samples_used[i], num_outliers[i]), end="")
 *             print('%11s' % converged[i])             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":365
 *             print('%11s' % converged[i])
 * 
 *     print('')             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":368
 * 
 *     # Print user configurations
 *     print('                                    config                       ' +             # <<<<<<<<<<<<<<
 *           '             ')
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":370
 *     print('                                    config                       ' +
 *           '             ')
 *     print('=================================================================' +             # <<<<<<<<<<<<<<
 *           '=============')
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":374
 * 
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":376
 *     print('                matrix                            ' +
 *           'stochastic estimator        ')
 *     print('-------------------------------------    ------------------------' +             # <<<<<<<<<<<<<<
 *           '-------------')
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":378
 *     print('-------------------------------------    ------------------------' +
 *           '-------------')
 *     print('gram:                           %5s' % gram, end="    ")             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":379
 *           '-------------')
 *     print('gram:                           %5s' % gram, end="    ")
 *     print('method:                    hutchinson')             # <<<<<<<<<<<<<<
 *     print('assumption:        %18s' % assume_matrix, end="    ")
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":380
 *     print('gram:                           %5s' % gram, end="    ")
 *     print('method:                    hutchinson')
 *     print('assumption:        %18s' % assume_matrix, end="    ")             # <<<<<<<<<<<<<<
 *     print('solver tol:                 %8.3e' % solver_tol)
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":381
 *     print('method:                    hutchinson')
 *     print('assumption:        %18s' % assume_matrix, end="    ")
 *     print('solver tol:                 %8.3e' % solver_tol)             # <<<<<<<<<<<<<<
 *     if int(exponent) == exponent:
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":382
 *     print('assumption:        %18s' % assume_matrix, end="    ")
 *     print('solver tol:                 %8.3e' % solver_tol)
 *     if int(exponent) == exponent:             # <<<<<<<<<<<<<<
 *         print('exponent:                         %3d' % int(exponent),
 ...
 */
  ...
  if (__pyx_t_4) {
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":383
 *     print('solver tol:                 %8.3e' % solver_tol)
 *     if int(exponent) == exponent:
 *         print('exponent:                         %3d' % int(exponent),             # <<<<<<<<<<<<<<
 *               end="    ")
 ...
 */
    ...
    /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":384
 *     if int(exponent) == exponent:
 *         print('exponent:                         %3d' % int(exponent),
 *               end="    ")             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":386
 *               end="    ")
 *     else:
 *         print('exponent:                      %6.2f' % exponent, end="    ")             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":387
 *     else:
 *         print('exponent:                      %6.2f' % exponent, end="    ")
 *     print('orthogonalization:               %4s' % orthogonalize)             # <<<<<<<<<<<<<<
 *     print('data type:                   %8s' % data_type_, end="    ")
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":388
 *         print('exponent:                      %6.2f' % exponent, end="    ")
 *     print('orthogonalization:               %4s' % orthogonalize)
 *     print('data type:                   %8s' % data_type_, end="    ")             # <<<<<<<<<<<<<<
 *     print('                                     ')
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":389
 *     print('orthogonalization:               %4s' % orthogonalize)
 *     print('data type:                   %8s' % data_type_, end="    ")
 *     print('                                     ')             # <<<<<<<<<<<<<<
 *     print('')
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":390
 *     print('data type:                   %8s' % data_type_, end="    ")
 *     print('                                     ')
 *     print('')             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":393
 * 
 *     # Prints convergence and error
 *     print('             convergence                                 ' +             # <<<<<<<<<<<<<<
 *           'error     ')
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":395
 *     print('             convergence                                 ' +
 *           'error     ')
 *     print('-------------------------------------    ------------------------' +             # <<<<<<<<<<<<<<
 *           '-------------')
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":397
 *     print('-------------------------------------    ------------------------' +
 *           '-------------')
 *     print('min num samples:                %5d' % min_num_samples, end="    ")             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":398
 *           '-------------')
 *     print('min num samples:                %5d' % min_num_samples, end="    ")
 *     print('abs error tol:              %8.3e' % error_atol)             # <<<<<<<<<<<<<<
 *     print('max num samples:                %5d' % max_num_samples, end="    ")
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":399
 *     print('min num samples:                %5d' % min_num_samples, end="    ")
 *     print('abs error tol:              %8.3e' % error_atol)
 *     print('max num samples:                %5d' % max_num_samples, end="    ")             # <<<<<<<<<<<<<<
 *     print('rel error tol:                  %4.2f%%' % error_rtol)
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":400
 *     print('abs error tol:              %8.3e' % error_atol)
 *     print('max num samples:                %5d' % max_num_samples, end="    ")
 *     print('rel error tol:                  %4.2f%%' % error_rtol)             # <<<<<<<<<<<<<<
 *     print('outlier significance level:     %4.2f%%'
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":402
 *     print('rel error tol:                  %4.2f%%' % error_rtol)
 *     print('outlier significance level:     %4.2f%%'
 *           % outlier_significance_level, end="    ")             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":401
 *     print('max num samples:                %5d' % max_num_samples, end="    ")
 *     print('rel error tol:                  %4.2f%%' % error_rtol)
 *     print('outlier significance level:     %4.2f%%'             # <<<<<<<<<<<<<<
 *           % outlier_significance_level, end="    ")
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":403
 *     print('outlier significance level:     %4.2f%%'
 *           % outlier_significance_level, end="    ")
 *     print('confidence level:              %4.2f%%' % confidence_level)             # <<<<<<<<<<<<<<
 *     print('')
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":404
 *           % outlier_significance_level, end="    ")
 *     print('confidence level:              %4.2f%%' % confidence_level)
 *     print('')             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":407
 * 
 *     # Print information about CPU and GPU
 *     print('                                   process                       ' +             # <<<<<<<<<<<<<<
 *           '             ')
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":409
 *     print('                                   process                       ' +
 *           '             ')
 *     print('=================================================================' +             # <<<<<<<<<<<<<<
 *           '=============')
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":411
 *     print('=================================================================' +
 *           '=============')
 *     print('                 time                                   device   ' +             # <<<<<<<<<<<<<<
 *           '               ')
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":413
 *     print('                 time                                   device   ' +
 *           '               ')
 *     print('-------------------------------------    ------------------------' +             # <<<<<<<<<<<<<<
 *           '-------------')
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":415
 *     print('-------------------------------------    ------------------------' +
 *           '-------------')
 *     print('tot wall time (sec):        %8.3e' % tot_wall_time, end="    ")             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":416
 *           '-------------')
 *     print('tot wall time (sec):        %8.3e' % tot_wall_time, end="    ")
 *     print('num cpu threads:                  %3d' % num_cpu_threads)             # <<<<<<<<<<<<<<
 *     print('alg wall time (sec):        %8.3e' % alg_wall_time, end="    ")
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":417
 *     print('tot wall time (sec):        %8.3e' % tot_wall_time, end="    ")
 *     print('num cpu threads:                  %3d' % num_cpu_threads)
 *     print('alg wall time (sec):        %8.3e' % alg_wall_time, end="    ")             # <<<<<<<<<<<<<<
 *     print('num gpu devices, multiproc:    %2d, %2d'
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":418
 *     print('num cpu threads:                  %3d' % num_cpu_threads)
 *     print('alg wall time (sec):        %8.3e' % alg_wall_time, end="    ")
 *     print('num gpu devices, multiproc:    %2d, %2d'             # <<<<<<<<<<<<<<
 *           % (num_gpu_devices, num_gpu_multiprocessors))
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":419
 *     print('alg wall time (sec):        %8.3e' % alg_wall_time, end="    ")
 *     print('num gpu devices, multiproc:    %2d, %2d'
 *           % (num_gpu_devices, num_gpu_multiprocessors))             # <<<<<<<<<<<<<<
 *     print('cpu proc time (sec):        %8.3e' % cpu_proc_time, end="    ")
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":420
 *     print('num gpu devices, multiproc:    %2d, %2d'
 *           % (num_gpu_devices, num_gpu_multiprocessors))
 *     print('cpu proc time (sec):        %8.3e' % cpu_proc_time, end="    ")             # <<<<<<<<<<<<<<
 *     print('num gpu threads per multiproc:   %4d'
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":422
 *     print('cpu proc time (sec):        %8.3e' % cpu_proc_time, end="    ")
 *     print('num gpu threads per multiproc:   %4d'
 *           % num_gpu_threads_per_multiprocessor)             # <<<<<<<<<<<<<<
 *     print('')
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":421
 *           % (num_gpu_devices, num_gpu_multiprocessors))
 *     print('cpu proc time (sec):        %8.3e' % cpu_proc_time, end="    ")
 *     print('num gpu threads per multiproc:   %4d'             # <<<<<<<<<<<<<<
 *           % num_gpu_threads_per_multiprocessor)
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":423
 *     print('num gpu threads per multiproc:   %4d'
 *           % num_gpu_threads_per_multiprocessor)
 *     print('')             # <<<<<<<<<<<<<<
 */
 ...
 */
  ...
  __Pyx_AddTraceback("pyrand.traceinv._hutchinson_method_utilities.print_summary", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  __pyx_L0:;
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_s_pyrand_traceinv__hutchinson_meth, __pyx_k_pyrand_traceinv__hutchinson_meth, sizeof(__pyx_k_pyrand_traceinv__hutchinson_meth), 0, 0, 1, 0},
  {&__pyx_n_s_pyrand_traceinv__hutchinson_meth_2, __pyx_k_pyrand_traceinv__hutchinson_meth_2, sizeof(__pyx_k_pyrand_traceinv__hutchinson_meth_2), 0, 0, 1, 1},
 ...
 */
  ...
  __pyx_codeobj_ = (PyObject*)__Pyx_PyCode_New(17, 0, 19, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__86, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_pyrand_traceinv__hutchinson_meth, __pyx_n_s_check_arguments, 22, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj_)) __PYX_ERR(0, 22, __pyx_L1_error)
 ...
 */
  ...
  __pyx_codeobj__61 = (PyObject*)__Pyx_PyCode_New(1, 0, 29, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__87, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_pyrand_traceinv__hutchinson_meth, __pyx_n_s_print_summary, 242, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__61)) __PYX_ERR(0, 242, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_pyrand__traceinv___hutchinson_method_utilities) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "pyrand.traceinv._hutchinson_method_utilities")) {
      if (unlikely(PyDict_SetItemString(modules, "pyrand.traceinv._hutchinson_method_utilities", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":14
 * # =======
 * 
 * import numpy             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":15
 * 
 * import numpy
 * from scipy.sparse import isspmatrix             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_6pyrand_8traceinv_28_hutchinson_method_utilities_1check_arguments, 0, __pyx_n_s_check_arguments, NULL, __pyx_n_s_pyrand_traceinv__hutchinson_meth_2, __pyx_d, ((PyObject *)__pyx_codeobj_)); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 22, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
 ...
 */
  ...
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_6pyrand_8traceinv_28_hutchinson_method_utilities_3print_summary, 0, __pyx_n_s_print_summary, NULL, __pyx_n_s_pyrand_traceinv__hutchinson_meth_2, __pyx_d, ((PyObject *)__pyx_codeobj__61)); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 242, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_print_summary, __pyx_t_2) < 0) __PYX_ERR(0, 242, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "pyrand/traceinv/_hutchinson_method_utilities.pyx":1
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init pyrand.traceinv._hutchinson_method_utilities", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init pyrand.traceinv._hutchinson_method_utilities");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
