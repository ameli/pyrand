...
def slq_method(
    ...
    gpu : bool, default=False
        ...
        .. note::
            ...
            :class:`pyrand.Matrix` class instead of `numpy` or `scipy` matrices.
    ...
    **Convergence for the case of multiple parameters:**
    ...
    When `A` is a type of :class:`pyrand.AffineMatrixFunction` representing the
    ...
    **Symmetric Input Matrix:**
    ...
    The `slq` method requires the input matrix of :func:`pyrand.traceinv`
    function to be symmetric when ``gram`` is `False`. For the first example,
    generate a symmetric sample matrix using :func:`pyrand.toeplitz` function as
    follows:
    ...
    In the above, by passing ``gram=True`` to :func:`pyrand.toeplitz` function,
    ...
    **Gramian Matrix:**
    ...
    Passing ``gram=True`` to :func:`pyrand.traceinv` function uses the Gramian
    ...
    **Verbose output:**
    ...
    .. literalinclude:: ../_static/data/pyrand.traceinv.slq-verbose-1.txt
        :language: python
    ...
    **Matrix operator:**
    ...
    Use an object of :class:`pyrand.Matrix` class as an alternative method to
    ...
    **Affine matrix operator:**
    ...
    Use an object of :class:`pyrand.AffineMatrixFunction` to create the linear
    operator
    ...
    .. literalinclude:: ../_static/data/pyrand.traceinv.slq-verbose-2.txt
        :language: python
