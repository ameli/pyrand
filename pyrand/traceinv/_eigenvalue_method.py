...
def eigenvalue_method(
    ...
    A : numpy.ndarray, scipy.sparse
        ...
        .. note::
            ...
            :class:`Matrix` or :class:`pyrand.AffineMatrixFunction` classes.
    ...
    **Dense matrix:**
    ...
    matrix created by :func:`pyrand.toeplitz` function:
    ...
    **Precomputed Eigenvalues:**
    ...
    Pre-computing eigenvalues can be useful if :func:`pyrand.traceinv` function
    ...
    **Sparse matrix:**
    ...
    :func:`pyrand.sample_matrices.toeplitz_traceinv` function.
