...
def trace(
    ...
    A : numpy.ndarray, scipy.sparse, :class:`pyrand.Matrix`, or \
        ...
        :ref:`slq method <pyrand.trace.slq>`. If ``method=slq`` and
    ...
    p : float, default=1.0
        ...
        * If ``method=slq``, :math:`p` should be non-negative real number.
        ...
        .. note::
            ...
            If :math:`p < 0`, use :func:`pyrand.traceinv` function.
    ...
    method : {'exact', 'eigenvalue', 'slq'}, default='exact'
        ...
        * :ref:`exact <pyrand.trace.exact>`
        * :ref:`eigenvalue <pyrand.trace.eigenvalue>`
        * :ref:`slq <pyrand.trace.slq>`
    ...
    info : dict
        ...
        * ``matrix``:
            ...
            * ``num_inquiries``: `int`, The size of inquiries of each parameter
              ...
              `1`. For more details see :ref:`slq method <pyrand.trace.slq>`.
    ...
    * :ref:`exact <pyrand.trace.exact>`: Computes trace directly from its
      diagonal entries. This is used when :math:`p` is integer. If :math:`p=1`,
      this method is preferred.
    * :ref:`eigenvalue <pyrand.trace.eigenvalue>`: uses spectral decomposition.
      Suitable for small matrices (:math:`n < 2^{12}`). The solution is exact.
    * :ref:`slq <pyrand.trace.slq>`: uses stochastic Lanczos quadrature (SLQ),
    ...
    **Sparse matrix:**
    ...
    .. code-block:: python
        ...
        >>> # Import packages
        >>> from pyrand import toeplitz, trace
    ...
    **Large matrix:**
    ...
    :func:`pyrand.sample_matrices.toeplitz_trace` for details.

    .. code-block:: python

        >>> from pyrand.sample_matrices import toeplitz_trace
    ...
    **Matrix operator:**
    ...
    :ref:`slq method <pyrand.trace.slq>`.

    .. code-block:: python
        :emphasize-lines: 8

        >>> # Import matrix operator
        >>> from pyrand import toeplitz, trace, Matrix
    ...
    **Affine matrix operator:**
    ...
    in :ref:`slq method <pyrand.trace.slq>`.

    .. code-block:: python
        :emphasize-lines: 8

        >>> # Import affine matrix function
        >>> from pyrand import toeplitz, trace, AffineMatrixFunction
