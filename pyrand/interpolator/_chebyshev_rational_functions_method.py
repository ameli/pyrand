...
class ChebyshevRationalFunctionsMethod(InterpolantBase):
    ...
    __call__
        See :meth:`pyrand.InterpolateSchatten.__call__`.
    eval
        See :meth:`pyrand.InterpolateSchatten.eval`.
    interpolate
        See :meth:`pyrand.InterpolateSchatten.interpolate`.
    get_scale
        See :meth:`pyrand.InterpolateSchatten.get_scale`.
    bound
        See :meth:`pyrand.InterpolateSchatten.bound`.
    upper_bound
        See :meth:`pyrand.InterpolateSchatten.upper_bound`.
    plot
        See :meth:`pyrand.InterpolateSchatten.plot`.
    ...
    **Plotting Interpolation and Compare with Exact Solution:**
    ...
    :meth:`pyrand.InterpolateSchatten.plot` function. To compare with the true
