...
class InterpolantBase(object):
    ...
    .. inheritance-diagram::
        pyrand.InterpolateTraceinv.ExactMethod
        pyrand.InterpolateTraceinv.EigenvaluesMethod
        pyrand.InterpolateTraceinv.MonomialBasisFunctionsMethod
        pyrand.InterpolateTraceinv.InverseMonomialBasisFunctionsMethod
        pyrand.InterpolateTraceinv.RadialBasisFunctionsMethod
        pyrand.InterpolateTraceinv.RationalPolynomialFunctionsMethod
        :parts: 1
