...
class InterpolateLogdet(InterpolateSchatten):
    ...
    options : dict, default={}
        ...
        using the function :func:`pyrand.logdet`. The ``options`` passes a
    ...
    **Basic Usage:**
    ...
    .. code-block:: python
        ...
        >>> from pyrand import InterpolateLogdet
        >>> ti = [1e-2, 1e-1, 1, 1e1]
    ...
    Alternatively, call :meth:`pyrand.InterpolateLogdet.interpolate` to
    ...
    interpolation, call :meth:`pyrand.InterpolateLogdet.eval` function:
    ...
    .. warning::
        ...
        Calling :meth:`pyrand.InterpolateLogdet.eval` may take a longer time
    ...
    **Passing Options:**
    ...
    :func:`pyrand.logdet` function. You can pass arguments to the latter
    ...
    :ref:`pyrand.logdet.slq` method with ``min_num_samples=20`` and
    ...
    **Interpolate on Range of Points:**
    ...
    instantiated, calling :meth:`pyrand.InterpolateLogdet.interpolate` on
    ...
    **Plotting Interpolation and Compare with Exact Solution:**
    ...
    :meth:`pyrand.InterpolateLogdet.plot` function.
    ...
    def get_scale(self):
        ...
        accessed by :meth:`pyrand.InterpolateLogdet.get_scale` function.
    ...
    def eval(self, t):
        ...
        pyrand.InterpolateLogdet.__call__
        pyrand.InterpolateLogdet.interpolate
    ...
    def plot(
        ...
        * If :math:`\\rm\\LaTeX` is not installed, it uses any available
        ...
        :meth:`pyrand.InterpolateLogdet.plot` function to plot the
