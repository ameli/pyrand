...
class InterpolateTrace(InterpolateSchatten):
    ...
    p : float, default=-1
        ...
        :class:`pyrand.InterpolateLogdet`.
    ...
    kind : {`'ext'`, `'eig'`, `'mbf'`, `'imbf'`, `'rbf'`, `'crf'`, `'spl'`, \
        ...
        in :class:`pyrand.InterpolateSchatten`. See documentation for each
        specific algorithm:
    ...
    **Basic Usage:**
    ...
    .. code-block:: python
        ...
        >>> from pyrand import InterpolateTrace
        >>> ti = [1e-2, 1e-1, 1, 1e1]
    ...
    Alternatively, call :meth:`pyrand.InterpolateTrace.interpolate` to
    ...
    interpolation, call :meth:`pyrand.InterpolateTrace.eval` function:
    ...
    .. warning::
        ...
        Calling :meth:`pyrand.InterpolateTrace.eval` may take a longer time
    ...
    **Passing Options:**
    ...
    :func:`pyrand.traceinv` function since :math:`p=-1` is negative. You can
    ...
    **Interpolate on Range of Points:**
    ...
    instantiated, calling :meth:`pyrand.InterpolateTrace.interpolate` on
    ...
    **Plotting Interpolation and Compare with Exact Solution:**
    ...
    :meth:`pyrand.InterpolateTrace.plot` function.
    ...
    def get_scale(self):
        ...
        accessed by :meth:`pyrand.InterpolateTrace.get_scale` function.
    ...
    def __call__(self, t):
        ...
        pyrand.InterpolateTrace.interpolate
    ...
    def eval(self, t):
        ...
        pyrand.InterpolateTrace.__call__
        pyrand.InterpolateTrace.interpolate
    ...
    def upper_bound(self, t):
        ...
        pyrand.InterpolateTrace.lower_bound
    ...
    def lower_bound(self, t):
        ...
        pyrand.InterpolateTrace.upper_bound
    ...
    def plot(
        ...
        * If :math:`\\rm\\LaTeX` is not installed, it uses any available
        ...
        :meth:`pyrand.InterpolateTrace.plot` function to plot the
