...
class ExactMethod(InterpolantBase):
    ...
    function value by calling :func:`pyrand.schatten`. The output of this
    ...
    options : dict, default={}
        The Schatten norm is computed using :func:`pyrand.schatten` function
    ...
    **Basic Usage:**
    ...
    Alternatively, call :meth:`pyrand.InterpolateSchatten.eval` to
    ...
    **Plotting:**
    ...
    To plot the function, call :meth:`pyrand.InterpolateSchatten.plot` method.
    ...
    def interpolate(self, t):
        ...
        :meth:`pyrand.InterpolateSchatten.eval` method.
