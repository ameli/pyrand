...
class InterpolateSchatten(object):
    ...
    options : dict, default={}
        ...
        using :func:`pyrand.schatten` function which itself calls either of

        * :func:`pyrand.logdet` (if :math:`p=0`)
        * :func:`pyrand.trace` (if :math:`p>0`)
        * :func:`pyrand.traceinv` (if :math:`p < 0`).
    ...
    kind : {`'ext'`, `'eig'`, `'mbf'`, `'imbf'`, `'rbf'`, `'crf'`, `'spl'`, \
        ...
        * :ref:`pyrand.InterpolateSchatten.ext`
        * :ref:`pyrand.InterpolateSchatten.eig`
        * :ref:`pyrand.InterpolateSchatten.mbf`
        * :ref:`pyrand.InterpolateSchatten.imbf`
        * :ref:`pyrand.InterpolateSchatten.rbf`
        * :ref:`pyrand.InterpolateSchatten.crf`
        * :ref:`pyrand.InterpolateSchatten.spl`
        * :ref:`pyrand.InterpolateSchatten.rpf`
    ...
    **Schatten Norm:**
    ...
    .. note::
        ...
        See [1]_ (Section 2) and the examples in :func:`pyrand.schatten` for
        details.
    ...
    **Basic Usage:**
    ...
    Alternatively, call :meth:`pyrand.InterpolateSchatten.interpolate` to
    ...
    interpolation, call :meth:`pyrand.InterpolateSchatten.eval` function:
    ...
    .. warning::
        ...
        Calling :meth:`pyrand.InterpolateSchatten.eval` may take a longer time
    ...
    **Arguments Specific to Algorithms:**
    ...
    of this algorithm at :ref:`pyrand.InterpolateSchatten.imbf`. In the next
    ...
    **Passing Options:**
    ...
    :func:`pyrand.trace` function since :math:`p=2` is positive. You can pass
    ...
    instance, to use :ref:`pyrand.trace.slq` method with ``min_num_samples=20``
    ...
    **Interpolate on Range of Points:**
    ...
    instantiated, calling :meth:`pyrand.InterpolateSchatten.interpolate` on
    ...
    **Plotting Interpolation and Compare with Exact Solution:**
    ...
    :meth:`pyrand.InterpolateSchatten.plot` function.
    ...
    def get_scale(self):
        ...
        accessed by :meth:`pyrand.InterpolateSchatten.get_scale` function.
    ...
    def __call__(self, t):
        ...
        pyrand.InterpolateSchatten.interpolate
        pyrand.InterpolateSchatten.eval
    ...
    def eval(self, t):
        ...
        pyrand.InterpolateSchatten.__call__
        pyrand.InterpolateSchatten.interpolate
    ...
    def bound(self, t):
        ...
        pyrand.InterpolateSchatten.upper_bound
    ...
    def plot(
        ...
        * On the other hand, if ``kind=crf`` or ``kind=spl``, the function
          ...
          :ref:`pyrand.InterpolateSchatten.crf` for ``kind=crf``. If
        ...
        * If :math:`\\rm\\LaTeX` is not installed, it uses any available
        ...
        :meth:`pyrand.InterpolateSchatten.plot` function to plot the
    ...
    def _plot_semi_infinite(
        ...
        :mod:`pyrand.InterpolateSchatten`.
