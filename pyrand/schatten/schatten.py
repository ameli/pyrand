...
def schatten(
    ...
    options : `**kwargs`
        ...
        * If :math:`p > 0`, see options for :func:`pyrand.trace`. In particular:

          * :ref:`pyrand.trace.exact`
          * :ref:`pyrand.trace.eigenvalue`
          * :ref:`pyrand.trace.slq`

        * If :math:`p = 0`, see options for :func:`pyrand.logdet`. In
          particular:

          * :ref:`pyrand.logdet.eigenvalue`
          * :ref:`pyrand.logdet.cholesky`
          * :ref:`pyrand.logdet.slq`

        * If :math:`p < 0`, see options for :func:`pyrand.traceinv`. In
          particular:

          * :ref:`pyrand.traceinv.eigenvalue`
          * :ref:`pyrand.traceinv.cholesky`
          * :ref:`pyrand.traceinv.hutchinson`
          * :ref:`pyrand.traceinv.slq`
    ...
    **Method and Options Arguments:**
    ...
    The :func:`pyrand.schatten` calls the following functions:

    * If :math:`p > 0`, the computation is passed to :func:`pyrand.trace`
      function.
    * If :math:`p = 0`, the computation is passed to :func:`pyrand.logdet`
      function.
    * If :math:`p < 0`, the computation is passed to :func:`pyrand.traceinv`
      function.
    ...
    **Verbose output:**
    ...
    .. literalinclude:: ../_static/data/pyrand.schatten-verbose.txt
        :language: python
    ...
    **Large Matrix:**
    ...
    :ref:`pyrand.trace.slq` function. Note that the SLQ method does not compute
    ...
    .. note::
        ...
        To see options passed to :func:`pyrand.schatten` for :math:`p > 0` in
        the example below, see the parameters of :ref:`pyrand.trace.slq`
