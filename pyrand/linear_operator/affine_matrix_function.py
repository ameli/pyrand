...
class AffineMatrixFunction(LinearOperator):
    ...
    :mod:`pyrand` that accepts ``slq`` method.
    ...
    **Where to use this class:**
    ...
    function in :mod:`pyrand` that accepts ``slq`` method. For instance, when
    calling :func:`pyrand.logdet` function using ``method=slq`` argument, the
    ...
    **Features:**
    ...
    This class internally creates instances of :class:`pyrand.Matrix` class for
    ...
    **Create an affine matrix function object:**
    ...
    .. code-block:: python
        ...
        >>> from pyrand import AffineMatrixFunction
    ...
    **Operation on CPU:**
    ...
    :mod:`pyrand` that accepts ``slq`` method, such as
    :func:`pyrand.logdet`. Compute log-determinant of :math:`\\mathbf{A}(t)` for
    ...
    **Operation on GPU:**
    ...
    this time by calling :func:`pyrand.logdet` function with ``gpu=True``
