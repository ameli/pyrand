...
def get_processor_name():
    ...
    .. code-block:: python
        ...
        >>> from pyrand.device import get_processor_name
        >>> get_processor_name()
...
def get_num_cpu_threads():
    ...
    .. code-block:: python
        ...
        >>> from pyrand.device import get_num_cpu_threads
        >>> get_num_cpu_threads()
        2
...
def get_gpu_name():
    ...
    .. code-block:: python
        ...
        >>> from pyrand.device import get_gpu_name
        >>> get_gpu_name()
        'GeForce GTX 1080 Ti'
    """
...
def get_num_gpu_devices():
    ...
    .. code-block:: python
        ...
        >>> from pyrand.device import get_num_gpu_devices
        >>> get_num_gpu_devices()
        4
    """
...
def get_nvidia_driver_version():
    ...
    .. code-block:: python
        ...
        >>> from pyrand.device import get_nvidia_driver_version
...
def restrict_to_single_processor():
    ...
    **Alternative Solution:**
    ...
    .. code-block:: python
        ...
        >>> from pyrand.device import restrict_to_single_processor
        >>> restrict_to_single_processor()
