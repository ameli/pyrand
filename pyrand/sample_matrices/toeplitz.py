...
def toeplitz(
    ...
    .. warning::
        ...
        applications, use :func:`pyrand.correlation_matrix` instead.
    ...
    .. code-block:: python
        ...
        >>> from pyrand.sample_matrices import toeplitz
        >>> a, b = 2, 3
...
def toeplitz_trace(a, b, size, gram=False):
    ...
    matrix generated by :func:`pyrand.toeplitz`.
    ...
    For the matrix :math:`\\mathbf{A}` given in :func:`pyrand.toeplitz`, the
...
def toeplitz_schatten(a, b, size, p=2):
    ...
    .. code-block:: python
        ...
        >>> from pyrand.sample_matrices import toeplitz_schatten
        >>> a, b = 2, 3
